...
export const productsFetch=createAsyncThunk(
    ...
    async (id=null,{rejectWithValue})=>{
        try{
            ...
            const response= await axios.get("https://shopping-mart-fp9c.onrender.com/api/products");
...
export const productsCreate=createAsyncThunk(
    ...
    async (values,{rejectWithValue})=>{
        try{
            console.log("enter")
            const response= await axios.post("https://shopping-mart-fp9c.onrender.com/api/products",values,{
                headers:{
